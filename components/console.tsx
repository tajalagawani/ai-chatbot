...
export function Console({ consoleOutputs, setConsoleOutputs }: ConsoleProps) {
  ...
  return consoleOutputs.length > 0 ? (
    <>
      ...
      <div
        className={cn(
          'fixed flex flex-col bottom-0 dark:bg-zinc-950 bg-zinc-50 w-full border-t z-40 overflow-y-scroll overflow-x-hidden dark:border-zinc-700 border-zinc-200',
          {
